  ...
  return (
    <div className="max-w-md mx-auto px-6 py-20 space-y-8 animate-fade-in">
      <div className="text-center space-y-2">
        ...
        <h1 className="text-3xl font-serif text-[#222222]">Create Account</h1>
        <p className="text-xs text-[#222222]/50 font-sans">Join to receive custom routine tracking and loyalty rewards.</p>
      </div>
      ...
      <form onSubmit={handleRegisterSubmit} className="bg-[#FFF8F2]/40 border border-[#E8DEC9]/30 rounded-2xl p-6 md:p-8 space-y-4 shadow-sm">
        <div className="space-y-1.5">
          ...
          <div className="flex items-center border border-[#E8DEC9] rounded-xl bg-[#FAF9F6] p-3 space-x-2">
            <User size={14} className="text-[#222222]/30" />
            <input
              type="text"
      ...
      <div className="text-center text-xs text-[#222222]/60 font-sans">
        ...
        <Link to="/login" className="text-[#D4AF37] font-semibold hover:text-[#222222] transition-colors">
          Sign in here
        </Link>
      </div>
    </div>
